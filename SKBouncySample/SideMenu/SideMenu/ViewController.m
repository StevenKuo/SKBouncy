...
- (void)viewDidLoad {
	...
	menu = [[SKBouncyMenu alloc] initWithFrame:CGRectMake(-150.0, 0.0, 150.0, self.view.frame.size.height) withItemInfo:@[@{SKBouncyMenuItemImageKey : [UIImage imageNamed:@"testMenuItem1"], SKBouncyMenuItemTitleKey : @"Settings"}, @{SKBouncyMenuItemImageKey : [UIImage imageNamed:@"testMenuItem2"], SKBouncyMenuItemTitleKey : @"LISMO"}]];
